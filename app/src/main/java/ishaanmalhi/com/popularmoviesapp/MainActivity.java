...
public class MainActivity extends AppCompatActivity implements FavoriteMovieFragment.Callback, MovieFragment.Callback {
    ...
    public void onItemSelected(Uri iduri) {
        if (mTwoPane) {
            Timber.d("Two pane Favorite Movies");
            ...
            Timber.d("Single Pane Favorite Movies");
    ...
    public void onItemSelected(MovieDetail movie) {
        if (mTwoPane) {
            Timber.d("Two pane regular");
            Bundle args = new Bundle();
            args.putParcelable("MovieDetails", movie);
            ...
            Timber.d("Single Pane Regular " + movie.title);
            Intent movieInfoIntent = new Intent(this,DetailActivity.class)
